...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/singlematch.plist")
local target_bottom = cc.Sprite:createWithSpriteFrameName("target_bottom.png")
target_bottom:setName("target_bottom")
target_bottom:setTag(59)
target_bottom:setCascadeColorEnabled(true)
target_bottom:setCascadeOpacityEnabled(true)
target_bottom:setPosition(141.3550, 92.7072)
...
--Create fangkuai_bg
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
local fangkuai_bg = cc.Sprite:createWithSpriteFrameName("water_bg.png")
fangkuai_bg:setName("fangkuai_bg")
fangkuai_bg:setTag(60)
fangkuai_bg:setCascadeColorEnabled(true)
fangkuai_bg:setCascadeOpacityEnabled(true)
fangkuai_bg:setPosition(140.4901, 98.2090)
...
layout:setPositionPercentY(0.6138)
layout:setPercentWidth(0.3125)
layout:setPercentHeight(0.4688)
layout:setSize({width = 75.0000, height = 75.0000})
layout:setLeftMargin(102.9901)
layout:setRightMargin(62.0100)
layout:setTopMargin(24.2911)
layout:setBottomMargin(60.7090)
