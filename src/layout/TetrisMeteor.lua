...
--Create meteor2_1
local meteor2_1 = cc.Sprite:create("ui/tetris/power/meteor2.png")
meteor2_1:setName("meteor2_1")
meteor2_1:setTag(71)
meteor2_1:setCascadeColorEnabled(true)
meteor2_1:setCascadeOpacityEnabled(true)
meteor2_1:setVisible(false)
meteor2_1:setAnchorPoint(0.0000, 0.0000)
meteor2_1:setPosition(365.0000, 292.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(meteor2_1)
layout:setPositionPercentX(0.5703)
layout:setPositionPercentY(0.2570)
...
meteor2_1:setBlendFunc({src = 1, dst = 771})
Scene:addChild(meteor2_1)

--Create meteor2_2
local meteor2_2 = cc.Sprite:create("ui/tetris/power/meteor2.png")
meteor2_2:setName("meteor2_2")
meteor2_2:setTag(72)
meteor2_2:setCascadeColorEnabled(true)
meteor2_2:setCascadeOpacityEnabled(true)
meteor2_2:setVisible(false)
meteor2_2:setAnchorPoint(0.0000, 0.0000)
meteor2_2:setPosition(500.0000, 782.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(meteor2_2)
layout:setPositionPercentX(0.7813)
layout:setPositionPercentY(0.6884)
layout:setPercentWidth(0.0406)
layout:setPercentHeight(0.0229)
layout:setSize({width = 26.0000, height = 26.0000})
...
meteor2_2:setBlendFunc({src = 1, dst = 771})
Scene:addChild(meteor2_2)
