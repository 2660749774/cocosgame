...
--Create popup_bg_4
local popup_bg_4 = cc.Sprite:create("ui/power/popup/power_pass_bg2.png")
...
popup_bg_4:setPosition(320.0002, 643.0876)
...
layout:setTopMargin(135.4124)
layout:setBottomMargin(285.5876)
...
btn_powercontinue:loadTextureNormal("power_pass_continue.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_powercontinue:loadTexturePressed("power_pass_continue.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_powercontinue:loadTextureDisabled("power_pass_continue.png",1)
...
--Create gem_bg
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
local gem_bg = cc.Sprite:createWithSpriteFrameName("gem_bg.png")
