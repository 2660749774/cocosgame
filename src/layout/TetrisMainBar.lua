...
bar_bg:loadTexture("main_bar_bg.png",1)
...
--Create energy_bg_3
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local energy_bg_3 = cc.Sprite:createWithSpriteFrameName("bar_bg2.png")
...
local energy_bg = cc.Sprite:createWithSpriteFrameName("energy_bg2.png")
...
energy_bg:setPosition(39.0927, 29.9734)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy_energy:loadTextureNormal("pay_bg.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy_energy:loadTexturePressed("pay_bg.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy_energy:loadTextureDisabled("pay_bg.png",1)
...
--Create item_bg_2
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local item_bg_2 = cc.Sprite:createWithSpriteFrameName("bar_bg2.png")
...
gem_bg:setPosition(33.0082, 29.9734)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy_item:loadTextureNormal("pay_bg.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy_item:loadTexturePressed("pay_bg.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy_item:loadTextureDisabled("pay_bg.png",1)
...
--Create bottom_bg
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local bottom_bg = cc.Sprite:createWithSpriteFrameName("bar_bg.png")
...
--Create bar1
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local bar1 = cc.Sprite:createWithSpriteFrameName("bar_unchoose.png")
bar1:setName("bar1")
bar1:setTag(307)
...
--Create bar2
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local bar2 = cc.Sprite:createWithSpriteFrameName("bar_unchoose.png")
bar2:setName("bar2")
bar2:setTag(312)
...
--Create bar3
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local bar3 = cc.Sprite:createWithSpriteFrameName("bar_unchoose.png")
bar3:setName("bar3")
bar3:setTag(313)
...
--Create bar_choose
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local bar_choose = cc.Sprite:createWithSpriteFrameName("bar_choose.png")
...
--Create bar_light
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
local bar_light = cc.Sprite:createWithSpriteFrameName("bar_light.png")
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_left:loadTextureNormal("btn_arrow.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_left:loadTexturePressed("btn_arrow.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_left:loadTextureDisabled("btn_arrow.png",1)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_right:loadTextureNormal("btn_arrow.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_right:loadTexturePressed("btn_arrow.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_right:loadTextureDisabled("btn_arrow.png",1)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_single:loadTextureNormal("btn_single.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_single:loadTexturePressed("btn_single.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_single:loadTextureDisabled("btn_single.png",1)
...
btn_rank:loadTextureNormal("ui/rank/icon_gold_cup.png",0)
btn_rank:loadTexturePressed("ui/rank/icon_gold_cup.png",0)
btn_rank:loadTextureDisabled("ui/rank/icon_gold_cup.png",0)
btn_rank:setTitleFontSize(14)
btn_rank:setTitleColor({r = 65, g = 65, b = 70})
btn_rank:setScale9Enabled(true)
btn_rank:setCapInsets({x = 15, y = 11, width = 46, height = 50})
...
btn_rank:setPosition(82.5000, 55.0000)
btn_rank:setScaleX(0.8000)
btn_rank:setScaleY(0.8000)
...
bottom_panel:addChild(btn_rank)

--Create btn_multi
local btn_multi = ccui.Button:create()
btn_multi:ignoreContentAdaptWithSize(false)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_multi:loadTextureNormal("btn_multi.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_multi:loadTexturePressed("btn_multi.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/main.plist")
btn_multi:loadTextureDisabled("btn_multi.png",1)
