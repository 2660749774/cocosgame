...
--Create lb_target_intro
local lb_target_intro = ccui.Text:create()
lb_target_intro:ignoreContentAdaptWithSize(true)
lb_target_intro:setTextAreaSize({width = 0, height = 0})
lb_target_intro:setFontSize(24)
lb_target_intro:setString([[目标说明]])
lb_target_intro:setTextHorizontalAlignment(1)
lb_target_intro:setTextVerticalAlignment(1)
lb_target_intro:enableShadow({r = 55, g = 168, b = 245, a = 255}, {width = 1, height = -1}, 0)
lb_target_intro:setLayoutComponentEnabled(true)
lb_target_intro:setName("lb_target_intro")
lb_target_intro:setTag(102)
lb_target_intro:setCascadeColorEnabled(true)
lb_target_intro:setCascadeOpacityEnabled(true)
lb_target_intro:setPosition(320.0000, 406.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(lb_target_intro)
layout:setPositionPercentX(0.5000)
...
popup_bg_4:addChild(lb_target_intro)
...
layout:setTopMargin(225.9601)
layout:setBottomMargin(456.0399)
...
layout:setTopMargin(360.1520)
layout:setBottomMargin(321.8480)
