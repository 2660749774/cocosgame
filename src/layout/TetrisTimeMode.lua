...
--Create target_bottom
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/singlematch.plist")
local target_bottom = cc.Sprite:createWithSpriteFrameName("target_bottom2.png")
target_bottom:setName("target_bottom")
target_bottom:setTag(244)
target_bottom:setCascadeColorEnabled(true)
target_bottom:setCascadeOpacityEnabled(true)
target_bottom:setPosition(133.3552, 96.7073)
target_bottom:setScaleX(0.8000)
target_bottom:setScaleY(0.8000)
layout = ccui.LayoutComponent:bindLayoutComponent(target_bottom)
...
layout:setLeftMargin(33.3552)
layout:setRightMargin(6.6448)
layout:setTopMargin(3.2927)
layout:setBottomMargin(36.7073)
target_bottom:setBlendFunc({src = 1, dst = 771})
lb_right_bg:addChild(target_bottom)

--Create lb_target
local lb_target = ccui.TextAtlas:create([[1000]],
													"ui/number_atlas/number2.png",
													20,
													25,
													"0")
lb_target:setLayoutComponentEnabled(true)
lb_target:setName("lb_target")
lb_target:setTag(246)
lb_target:setCascadeColorEnabled(true)
lb_target:setCascadeOpacityEnabled(true)
lb_target:setPosition(133.7320, 89.7462)
layout = ccui.LayoutComponent:bindLayoutComponent(lb_target)
layout:setPositionPercentX(0.5572)
layout:setPositionPercentY(0.5609)
layout:setPercentWidth(0.3333)
layout:setPercentHeight(0.1563)
layout:setSize({width = 80.0000, height = 25.0000})
layout:setLeftMargin(93.7320)
layout:setRightMargin(66.2680)
layout:setTopMargin(57.7538)
layout:setBottomMargin(77.2462)
lb_right_bg:addChild(lb_target)

--Create pg_result
local pg_result = ccui.Slider:create()
pg_result:ignoreContentAdaptWithSize(false)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/singlematch.plist")
pg_result:loadBarTexture("progress_bg.png",1)
...
pg_result:setPosition(133.2489, 48.5003)
layout = ccui.LayoutComponent:bindLayoutComponent(pg_result)
layout:setPositionPercentX(0.5552)
layout:setPositionPercentY(0.3031)
layout:setPercentWidth(0.7000)
layout:setPercentHeight(0.1563)
layout:setSize({width = 168.0000, height = 25.0000})
layout:setLeftMargin(49.2489)
layout:setRightMargin(22.7511)
layout:setTopMargin(98.9997)
layout:setBottomMargin(36.0003)
...
lb_result:setPosition(133.5374, 49.4666)
lb_result:setTextColor({r = 224, g = 165, b = 51})
...
layout:setLeftMargin(118.5374)
layout:setRightMargin(91.4626)
layout:setTopMargin(100.5334)
layout:setBottomMargin(39.4666)
