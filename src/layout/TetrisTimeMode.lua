...
tetris_panel:setPosition(226.5000, 693.5000)
...
--Create lb_time_title
local lb_time_title = ccui.Text:create()
lb_time_title:ignoreContentAdaptWithSize(true)
lb_time_title:setTextAreaSize({width = 0, height = 0})
lb_time_title:setFontSize(28)
lb_time_title:setString([[时  间]])
lb_time_title:setLayoutComponentEnabled(true)
lb_time_title:setName("lb_time_title")
lb_time_title:setTag(105)
lb_time_title:setCascadeColorEnabled(true)
lb_time_title:setCascadeOpacityEnabled(true)
lb_time_title:setPosition(512.7966, 1012.4720)
layout = ccui.LayoutComponent:bindLayoutComponent(lb_time_title)
layout:setPositionPercentX(0.8012)
layout:setPositionPercentY(0.8913)
layout:setPercentWidth(0.1125)
layout:setPercentHeight(0.0282)
layout:setSize({width = 72.0000, height = 32.0000})
layout:setLeftMargin(476.7966)
layout:setRightMargin(91.2034)
layout:setTopMargin(107.5280)
layout:setBottomMargin(996.4720)
panel:addChild(lb_time_title)

--Create lb_time
local lb_time = ccui.TextAtlas:create([[5211]],
													"ui/tetris/number.png",
													30,
													50,
													"0")
...
lb_time:setPosition(514.0000, 956.0000)
...
layout:setBottomMargin(931.0000)
panel:addChild(lb_time)

--Create lb_left_line_title
local lb_left_line_title = ccui.Text:create()
lb_left_line_title:ignoreContentAdaptWithSize(true)
lb_left_line_title:setTextAreaSize({width = 0, height = 0})
lb_left_line_title:setFontSize(28)
lb_left_line_title:setString([[ 剩余块数]])
lb_left_line_title:setLayoutComponentEnabled(true)
lb_left_line_title:setName("lb_left_line_title")
lb_left_line_title:setTag(24)
lb_left_line_title:setCascadeColorEnabled(true)
lb_left_line_title:setCascadeOpacityEnabled(true)
lb_left_line_title:setPosition(509.5965, 431.2727)
layout = ccui.LayoutComponent:bindLayoutComponent(lb_left_line_title)
layout:setPositionPercentX(0.7962)
layout:setPositionPercentY(0.3796)
layout:setPercentWidth(0.1875)
layout:setPercentHeight(0.0282)
layout:setSize({width = 120.0000, height = 32.0000})
layout:setLeftMargin(449.5965)
layout:setRightMargin(70.4035)
layout:setTopMargin(688.7273)
layout:setBottomMargin(415.2727)
panel:addChild(lb_left_line_title)
...
lb_left_line:setPosition(512.5682, 381.4293)
...
layout:setLeftMargin(482.5682)
layout:setRightMargin(97.4318)
layout:setTopMargin(729.5707)
layout:setBottomMargin(356.4293)
