...
lb_score:setPosition(514.6843, 824.1844)
...
layout:setLeftMargin(454.6843)
layout:setRightMargin(65.3157)
layout:setTopMargin(286.8156)
layout:setBottomMargin(799.1844)
...
lb_time_title:setPosition(494.5137, 1014.4720)
...
layout:setLeftMargin(452.5137)
layout:setRightMargin(103.4863)
layout:setTopMargin(107.5284)
layout:setBottomMargin(1000.4720)
...
lb_time:setPosition(508.3256, 955.9854)
...
layout:setPercentHeight(0.0440)
layout:setSize({width = 120.0000, height = 50.0000})
layout:setLeftMargin(448.3256)
layout:setRightMargin(71.6744)
layout:setTopMargin(155.0146)
layout:setBottomMargin(930.9854)
