...
--Create fangkuai_3
local fangkuai_3 = cc.Sprite:create("tetris/fangkuai.png")
...
layout:setLeftMargin(267.3345)
layout:setRightMargin(343.6655)
layout:setTopMargin(73.5000)
layout:setBottomMargin(1033.5000)
fangkuai_3:setBlendFunc({src = 770, dst = 771})
...
--Create score_bg
local score_bg = cc.Sprite:create("ui/tetris/power/water_bg.png")
...
pg_result:loadProgressBarTexture("ui/tetris/power/progress_blue.png",0)
