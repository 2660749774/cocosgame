...
--Create fangkuai_bg
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
local fangkuai_bg = cc.Sprite:createWithSpriteFrameName("meteor_bg.png")
