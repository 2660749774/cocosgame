...
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy:loadTextureNormal("btn_buy_time.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy:loadTexturePressed("btn_buy_time.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("ui/plist/common.plist")
btn_buy:loadTextureDisabled("btn_buy_time.png",1)
